package com.challenge.ecommerce.controllers.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> existingAddress(ExistingAddressException e, HttpServletRequest request) {
